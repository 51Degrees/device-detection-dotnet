...
./dotnet/build-package-requirement.ps1 -RepoName $RepoName -ProjectDir "FiftyOne.DeviceDetection.Hash.Engine.OnPremise" -Name $Name -Configuration "Release" -Arch $Arch
