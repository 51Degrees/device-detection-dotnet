...
namespace FiftyOne.DeviceDetection
{
	...
	public interface IDeviceData : IAspectData
	{
		...
		/// </summary>
		IAspectPropertyValue<bool> HasWebDriver { get; }
		/// <summary>
		...
		/// </summary>
		IAspectPropertyValue<JavaScript> HasWebDriverJavaScript { get; }
		/// <summary>
		...
		/// </summary>
		IAspectPropertyValue<bool> IsHeadless { get; }
		/// <summary>
		...
		/// </summary>
		IAspectPropertyValue<bool> IsVisible { get; }
		/// <summary>
		...
		/// </summary>
		IAspectPropertyValue<JavaScript> IsVisibleJavaScript { get; }
		/// <summary>
