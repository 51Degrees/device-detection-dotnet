...
public class VectorStringSwig : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<string>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          DeviceDetectionHashEngineModulePINVOKE.delete_VectorStringSwig(swigCPtr);
        }
  ...
  public VectorStringSwig() : this(DeviceDetectionHashEngineModulePINVOKE.new_VectorStringSwig__SWIG_0(), true) {
  }
  ...
  public void Clear() {
    DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_Clear(swigCPtr);
  }
  ...
  private uint size() {
    uint ret = DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_size(swigCPtr);
    return ret;
  }

  private bool empty() {
    bool ret = DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_empty(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_reserve(swigCPtr, n);
  }

  public VectorStringSwig(int capacity) : this(DeviceDetectionHashEngineModulePINVOKE.new_VectorStringSwig__SWIG_2(capacity), true) {
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
  }

  private string getitemcopy(int index) {
    string ret = DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_getitemcopy(swigCPtr, index);
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private string getitem(int index) {
    string ret = DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_getitem(swigCPtr, index);
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void AddRange(VectorStringSwig values) {
    DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_AddRange(swigCPtr, VectorStringSwig.getCPtr(values));
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void Insert(int index, string x) {
    DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_Insert(swigCPtr, index, x);
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, VectorStringSwig values) {
    DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_InsertRange(swigCPtr, index, VectorStringSwig.getCPtr(values));
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void RemoveRange(int index, int count) {
    DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_RemoveRange(swigCPtr, index, count);
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void Reverse() {
    DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_Reverse__SWIG_0(swigCPtr);
  }
  ...
  public bool Contains(string value) {
    bool ret = DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_Contains(swigCPtr, value);
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int IndexOf(string value) {
    int ret = DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_IndexOf(swigCPtr, value);
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int LastIndexOf(string value) {
    int ret = DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_LastIndexOf(swigCPtr, value);
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool Remove(string value) {
    bool ret = DeviceDetectionHashEngineModulePINVOKE.VectorStringSwig_Remove(swigCPtr, value);
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
