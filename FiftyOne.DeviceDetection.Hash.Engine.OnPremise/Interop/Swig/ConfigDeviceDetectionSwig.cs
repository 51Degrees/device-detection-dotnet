...
public class ConfigDeviceDetectionSwig : ConfigBaseSwig {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(ConfigDeviceDetectionSwig obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
