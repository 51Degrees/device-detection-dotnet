...
/// <summary>
/// @example Pattern/ConfigureFromFile/Program.cs
/// 
/// Configure from file example of using 51Degrees device detection.
/// 
/// This example is available in full on [GitHub](https://github.com/51Degrees/device-detection-dotnet/blob/release/v4.1.0/FiftyOne.DeviceDetection/Examples/Framework/Pattern/ConfigureFromFile/Program.cs). 
...
/// ```
/// </summary>
namespace FiftyOne.DeviceDetection.Examples.Pattern.ConfigureFromFile
{
