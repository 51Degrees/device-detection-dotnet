...
/// <summary>
/// @example Pattern/Performance/Program.cs
///
/// Performance example of using 51Degrees device detection.
/// 
/// This example is available in full on [GitHub](https://github.com/51Degrees/device-detection-dotnet/blob/release/v4.1.0/FiftyOne.DeviceDetection/Examples/Framework/Pattern/Performance/Program.cs). 
...
///
/// 1. Build a new on-premise Pattern engine with the maximum performance profile.
/// ```
...
/// ```
/// </summary>
namespace FiftyOne.DeviceDetection.Examples.Pattern.Performance
{
        ...
        public class Example : ExampleBase
        {
                ...
                IPipeline pipeline)
            {
                ...
                try
                {
                    ...
                    Parallel.ForEach(
                        Report(GetUserAgents(uaFile, count).ToList(),
                            count, maxDistinctUAs, 40),
                        new ParallelOptions()
                        {
                    ...
                    Console.WriteLine($"IsMobile = Unknwon : {isMobileUnknown}");
                }
