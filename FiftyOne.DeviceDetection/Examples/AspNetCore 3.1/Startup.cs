...
/// @example DeviceDetectionWebDemoNetCore3_1/Startup.cs
/// This example shows how to integrate the Pipeline API with a 
/// device detection engine into an ASP.NET Core web app.
/// 
/// The source code for this example is available in full on [GitHub](https://github.com/51Degrees/device-detection-dotnet/tree/release/v4.1.0/FiftyOne.DeviceDetection/Examples/DeviceDetectionWebDemoNetCore3_1). 
...
namespace DeviceDetectionWebDemoNetCore3_1
{
    public class Startup
    {
