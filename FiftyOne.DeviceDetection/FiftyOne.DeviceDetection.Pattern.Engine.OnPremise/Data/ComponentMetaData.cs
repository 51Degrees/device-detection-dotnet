...
namespace FiftyOne.DeviceDetection.Pattern.Engine.OnPremise.Data
{
    public class ComponentMetaData : IComponentMetaData, IDisposable
    {
        ...
        internal ComponentMetaData(DeviceDetectionPatternEngine engine, ComponentMetaDataSwig source)
        {
            _engine = engine;
            _source = source;
        }
        ...
        public IEnumerable<IFiftyOneAspectPropertyMetaData> GetProperties()
        {
                ...
                _engine.MetaData.getPropertiesForComponent(_source))
            {
                ...
                {
                    yield return new PropertyMetaDataPattern(
                        _engine,
        ...
        public IFiftyOneAspectPropertyMetaData GetProperty(string propertyName)
        {
                ...
                _engine.MetaData.getPropertiesForComponent(_source))
            {
                ...
                if (property != null)
                {
                    result = new PropertyMetaDataPattern(_engine, property);
                }
            }
            return result;
        }
