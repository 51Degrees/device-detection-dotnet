...
{
    public class PropertyMetaDataPattern : IFiftyOneAspectPropertyMetaData, IDisposable
    {
        private readonly PropertyMetaDataSwig _source;
        private readonly DeviceDetectionPatternEngine _engine;

        internal PropertyMetaDataPattern(DeviceDetectionPatternEngine engine, PropertyMetaDataSwig source)
        {
            _source = source;
            _engine = engine;
        ...
        {
            return new ValueMetaData(_engine, _engine.MetaData.getDefaultValueForProperty(_source));
        }
