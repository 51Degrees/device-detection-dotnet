...
namespace FiftyOne.DeviceDetection.Pattern.Engine.OnPremise.Wrappers
{
    internal class SwigFactory : ISwigFactory
    {
        ...
        public SwigFactory()
        {
            ...
            {
                var engine = new EnginePatternSwig(fileName, config.Object, requiredProperties.Object);
                return new EngineSwigWrapper(engine);
            };
            EngineFromData = (data, dataSize, config, requiredProperties) =>
            {
                var engine = new EnginePatternSwig(data, dataSize, config.Object, requiredProperties.Object);
                return new EngineSwigWrapper(engine);
            };
            ...
            ConfigFactory = () => { return new ConfigSwigWrapper(new ConfigPatternSwig()); };
        }
