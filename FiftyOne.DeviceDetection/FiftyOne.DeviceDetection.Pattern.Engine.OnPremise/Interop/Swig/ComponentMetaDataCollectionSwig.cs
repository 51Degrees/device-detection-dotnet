...
internal class ComponentMetaDataCollectionSwig : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          DeviceDetectionPatternEngineModulePINVOKE.delete_ComponentMetaDataCollectionSwig(swigCPtr);
        }
  ...
  public ComponentMetaDataSwig getByKey(SWIGTYPE_p_byte key) {
    global::System.IntPtr cPtr = DeviceDetectionPatternEngineModulePINVOKE.ComponentMetaDataCollectionSwig_getByKey(swigCPtr, SWIGTYPE_p_byte.getCPtr(key));
  ...
  public ComponentMetaDataSwig getByIndex(uint index) {
    global::System.IntPtr cPtr = DeviceDetectionPatternEngineModulePINVOKE.ComponentMetaDataCollectionSwig_getByIndex(swigCPtr, index);
    ComponentMetaDataSwig ret = (cPtr == global::System.IntPtr.Zero) ? null : new ComponentMetaDataSwig(cPtr, true);
    if (DeviceDetectionPatternEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionPatternEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public uint getSize() {
    uint ret = DeviceDetectionPatternEngineModulePINVOKE.ComponentMetaDataCollectionSwig_getSize(swigCPtr);
    if (DeviceDetectionPatternEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionPatternEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
