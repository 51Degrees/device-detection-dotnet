...
internal class ProfileMetaDataCollectionSwig : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          DeviceDetectionPatternEngineModulePINVOKE.delete_ProfileMetaDataCollectionSwig(swigCPtr);
        }
  ...
  public ProfileMetaDataSwig getByKey(uint key) {
    global::System.IntPtr cPtr = DeviceDetectionPatternEngineModulePINVOKE.ProfileMetaDataCollectionSwig_getByKey(swigCPtr, key);
  ...
  public ProfileMetaDataSwig getByIndex(uint index) {
    global::System.IntPtr cPtr = DeviceDetectionPatternEngineModulePINVOKE.ProfileMetaDataCollectionSwig_getByIndex(swigCPtr, index);
    ProfileMetaDataSwig ret = (cPtr == global::System.IntPtr.Zero) ? null : new ProfileMetaDataSwig(cPtr, true);
    if (DeviceDetectionPatternEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionPatternEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public uint getSize() {
    uint ret = DeviceDetectionPatternEngineModulePINVOKE.ProfileMetaDataCollectionSwig_getSize(swigCPtr);
    if (DeviceDetectionPatternEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionPatternEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
