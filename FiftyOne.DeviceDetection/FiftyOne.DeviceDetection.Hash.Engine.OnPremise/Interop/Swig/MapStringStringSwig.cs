...
internal class MapStringStringSwig : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, string>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          DeviceDetectionHashEngineModulePINVOKE.delete_MapStringStringSwig(swigCPtr);
        }
  ...
  public MapStringStringSwig() : this(DeviceDetectionHashEngineModulePINVOKE.new_MapStringStringSwig__SWIG_0(), true) {
  }
  ...
  private uint size() {
    uint ret = DeviceDetectionHashEngineModulePINVOKE.MapStringStringSwig_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = DeviceDetectionHashEngineModulePINVOKE.MapStringStringSwig_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    DeviceDetectionHashEngineModulePINVOKE.MapStringStringSwig_Clear(swigCPtr);
  }

  private string getitem(string key) {
    string ret = DeviceDetectionHashEngineModulePINVOKE.MapStringStringSwig_getitem(swigCPtr, key);
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool ContainsKey(string key) {
    bool ret = DeviceDetectionHashEngineModulePINVOKE.MapStringStringSwig_ContainsKey(swigCPtr, key);
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool Remove(string key) {
    bool ret = DeviceDetectionHashEngineModulePINVOKE.MapStringStringSwig_Remove(swigCPtr, key);
    if (DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Pending) throw DeviceDetectionHashEngineModulePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = DeviceDetectionHashEngineModulePINVOKE.MapStringStringSwig_create_iterator_begin(swigCPtr);
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = DeviceDetectionHashEngineModulePINVOKE.MapStringStringSwig_get_next_key(swigCPtr, swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    DeviceDetectionHashEngineModulePINVOKE.MapStringStringSwig_destroy_iterator(swigCPtr, swigiterator);
  }
