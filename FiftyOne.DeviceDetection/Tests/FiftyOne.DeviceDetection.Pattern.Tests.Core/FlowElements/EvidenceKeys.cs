...
namespace FiftyOne.DeviceDetection.Pattern.Tests.Core.FlowElements
{
    ...
    public class EvidenceKeysPatternCoreTests : TestsBase
    {
        [TestInitialize]
        public void Init()
        {
        ...
        [TestMethod]
        public void EvidenceKeys_Pattern_Core_ContainsUserAgent()
        {
            EvidenceKeyTests.ContainsUserAgent(Wrapper);
        }
        [TestMethod]
        public void EvidenceKeys_Pattern_Core_ContainsHeaderNames()
        {
            EvidenceKeyTests.ContainsHeaderNames(Wrapper);
        }
        [TestMethod]
        public void EvidenceKeys_Pattern_Core_ContainsOverrides()
        {
            EvidenceKeyTests.ContainsOverrides(Wrapper);
        }
        [TestMethod]
        public void EvidenceKeys_Pattern_Core_CaseInsensitiveKeys()
        {
