...
namespace FiftyOne.DeviceDetection.Pattern.Tests.Core.Data
{
    ...
    [TestCategory("Core")]
    [TestCategory("Values")]
    public class ValuesPatternCoreTests : TestsBase
    {
        [TestInitialize]
        public void Init()
        {
        ...
        [TestMethod]
        public void Values_Pattern_Core_Types()
        {
            ValueTests.ValueTypes(Wrapper);
        }

        [TestMethod]
        public void Values_Pattern_Core_AvailableProperties()
        {
            ValueTests.AvailableProperties(Wrapper);
        }

        [TestMethod]
        public void Values_Pattern_Core_TypedGetters()
        {
            ValueTests.TypedGetters(Wrapper);
        }

        [TestMethod]
        public void Values_Pattern_Core_DeviceId()
        {
            ValueTests.DeviceId(Wrapper);
        }

        [TestMethod]
        public void Values_Pattern_Core_MatchedUserAgents()
        {
