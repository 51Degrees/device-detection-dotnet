...
namespace FiftyOne.DeviceDetection.Hash.Tests.Framework.FlowElements
{
    [TestClass]
    [TestCategory("Framework")]
    [TestCategory("Process")]
    public class ProcessHashFrameworkTests : TestsBase
    {
        [TestInitialize]
        public void Init()
        {
